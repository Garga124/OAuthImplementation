...
namespace Server
{
    public class SeedData
    {
        ...
        private static void EnsureSeedData(ConfigurationDbContext context)
        {
            ...
            {
                foreach (var resources  in Config.IdentityResources.ToList())
                {
            ...
            {
                foreach (var resources in Config.ApiResources.ToList())
                {
            ...
            {
                foreach (var resources in Config.ApiScopes.ToList())
                {
                    context.ApiScopes.Add(resources.ToEntity()); 
